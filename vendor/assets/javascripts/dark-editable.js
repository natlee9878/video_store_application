class DarkEditable {
  ...
  init_options() {
    ...
    get_opt("url", null);
    get_opt("url", null);
    get_opt("attribute", 'error_must_pass_column_being_updated');
  ...
  createButtonSuccess() {
    ...
    btn_success.classList.add("inline-submit-js");
    btn_success.innerHTML = "Save";
    return btn_success;
  }
  ...
  async ajax(new_value) {
    ...
    form.append(this.attribute, new_value);
    const option = {};

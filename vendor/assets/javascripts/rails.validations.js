  ...
  var ClientSideValidations = {
    ...
    enablers: {
      form: function form(_form2) {
        var $form = $(_form2);
        // var type = SimpleForm::SimpleBuilder if _form2.ClientSideValidations.settings.html_settings.type == NestedForm::SimpleBuilder
        _form2.ClientSideValidations = {
          settings: $form.data('clientSideValidations'),
          addError: function addError(element, message) {
            var $type = _form2.ClientSideValidations.settings.html_settings.type
            if ($type.toString() == 'NestedForm::SimpleBuilder') {
              $type = 'SimpleForm::FormBuilder'
            }

            return ClientSideValidations.formBuilders[$type].add(element, _form2.ClientSideValidations.settings.html_settings, message);
          },
          removeError: function removeError(element) {
            ...
            return ClientSideValidations.formBuilders[$type].remove(element, _form2.ClientSideValidations.settings.html_settings);
          }
        };
